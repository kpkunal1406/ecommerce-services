...
import com.ecommerce.catalog.feign.ImageClient;
...
class ProductServiceImplTest {
    ...
    public void testOptimisticLocking() {
        ...
        Mockito.doThrow(OptimisticLockException.class).when(productRepository).save(product);

        Assertions.assertThrows(OptimisticLockException.class, () -> {
            serviceTest.update(product);
        });
    }
}
